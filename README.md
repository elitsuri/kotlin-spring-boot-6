...
> Kotlin Spring Boot: Spring Boot API with Kotlin, JPA, JWT, and PostgreSQL
...
## 🧰 Tech Stack
Kotlin, Ktor, PostgreSQL, Exposed, Docker
...
git clone https://github.com/elitsuri/kotlin-spring-boot
